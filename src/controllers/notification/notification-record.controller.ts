...
export class NotificationRecordController extends BaseController {
  ...
  findOne(@Param('id') id: string) {
    return this.service.findOne(this.decode(id));
  }

  @Patch(':id')
  @RequirePermission('UPDATE', 'notification')
  update(@Param('id') id: string, @Body() body: any) {
    return this.service.update(this.decode(id), body);
  }
